...
<html>
    <head>
		...
		<title>Contracted Companies</title>
    </head>
	<body>


<div class="container" >
<h1 class ="display-5 fw-bold text-center" style="margin-top:50px;">Current Contracts</h1>
<div class="row justify-content-center">
  <div class="col-md-6 text-center">
<p class ="display-6 fs-5 text-secondary" name = "product" value ="avail">View all companies you are currently contracted to</p>
</div>
