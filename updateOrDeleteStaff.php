...
<html lang="en">
    ...
    <body> <!-- Later fill the values of the textboxes after shaun and xz finish their code.-->
        <div class="container" >
            ...
            if (isset($_POST['submit'])) {
                if ($equipmentName == "") {
                    ...
                    try {
                        ...
                        $sql = "UPDATE $tablename set staff_role = $role, staff_name = $name, email = $email, phone = $phoneNumber where staff_ID = ";
                        //printf("Affected rows (INSERT): %d\n", $conn->affected_rows);
                        mysqli_query($conn, $sql);
                        echo "<p class=text-center>Staff $name from $companyName details has been updated</p>"; 
                ...
                if ($equipmentName == "") {
                    ...
                    try {
                        ...
                        //printf("Affected rows (INSERT): %d\n", $conn->affected_rows);
                        mysqli_query($conn, $sql);
                        echo "<p class=text-center>Staff $name from $companyName has been deleted</p>"; 
